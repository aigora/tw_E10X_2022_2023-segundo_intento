...
int main()
{
	...
	int palabra8=0,lineas8=0,palabra9=0,lineas9=0,palabra10=0,lineas10=0,palabra11=0,lineas11=0,palabra12,lineas12,palabra13,lineas13;
	...
	float num,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,num15,num16,num17,num18,num19;
	char datoAnd,datoArg,datoAst,datoCant,datoMan,datoLeon,datoCat,datoCeu,datoMad,datoVal,datoExtr,datoGal,datoBal;
		...
		while(fscanf(fBaleares, "%c",&datoBal)!=EOF)//Lee el fichero hasta el final como si fuera un caracter
		{
			...
			{	
				if(datoBal==',')//Cuando hay una coma suma una palabra
				{
					...
					{
						fscanf(fBaleares,"%f",&num13);//Hacemos otro scanf para poder leer los valores de cada linea como un número
						if(lineas13==5)//Hidráulica
						{
							hidrau13[i]=num13;
							i++;
						}
						if(lineas13==6)//Eólica
						{
							eoli13[i]=num13;
							i++;
						}
		...
		while(fscanf(fNavarra, "%c",&datoNav)!=EOF)//Lee el fichero hasta el final como si fueraun caracter
		{
			...
			{	
				if(datoNav==',')//Cuando hay una coma suma una palabra
				{
					...
					{
						fscanf(fNavarra,"%f",&num18);//Hacemos otro scanf para poder leer los valores de cada linea como un número
						if(lineas18==5)//Hidráulica
						{
							hidrau18[i]=num18;
							i++;
						}
						if(lineas18==6)//Eólica
						{
							eoli18[i]=num18;
							i++;
						}
						...
						if(lineas18==9)//Genereación total
						{
							total18[i]=num18;
							i++;
						}
		...
		while(fscanf(fPvasco, "%c",&datoPvasco)!=EOF)//Lee el fichero hasta el final como si fueraun caracter
		{
			...
			{	
				if(datoPvasco==',')//Cuando hay una coma suma una palabra
				{
					...
					{
						fscanf(fPvasco,"%f",&num19);//Hacemos otro scanf para poder leer los valores de cada linea como un número
						if(lineas19==5)//Hidráulica
						{
							hidrau19[i]=num19;
							i++;
						}
						if(lineas19==6)//Eólica
						{
							eoli19[i]=num19;
							i++;
						}
						...
						if(lineas19==10)//Genereación total
						{
							total19[i]=num19;
							i++;
						}
	...
	switch(comunidad)//Para cada comunidad un numero 
	{
		...
		case 13://Islas Baleares
			{	
				...
				}while(comunidad==13);//La condición es solo para el caso 13
			break;
			}
		case 15://LaRioja
			{	
		...
		case 18://Navarra
			{	
				...
				}while(comunidad==18);//La condición es solo para el caso 1
			break;
		}
		case 19://Pais Vasco
			{	
				...
				}while(comunidad==19);//La condición es solo para el caso 1
			break;
		}		
